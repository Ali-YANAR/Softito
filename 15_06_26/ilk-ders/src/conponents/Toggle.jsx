                ...
                <div className="space-y-4">
                    <div>
                        ...
                        <div className="relative">
                            <input type={sifreGoster ? "text" : "password"} value={girisSifre} onChange={(e) => setGirisSifre(e.target.value)} className={geceModu ? "demo-input demo-input-dark or-20" : "demo-input pr-20"}></input>
                    ...
                    <div className="demo-state-info">
                        ...
                        <ul className="demo-info-list">
                            ...
                            <li>Şifre Göster : <code>{sifreGoster ? "Açık" : "kapalı"}</code></li>
                        </ul>
                    </div>
