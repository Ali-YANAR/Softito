...
import Counter from './conponents/Conter';
import Toggle from './conponents/Toggle';
import Object from './conponents/Object';
import ArrayState from './conponents/ArrayState';
import MultipleInputs from './Multipleınput';
import DynamicFormFields from './conponents/DynamicFormFields';
      ...
      <div className='p-4 md:p-6 bg-gray-100 min-h-screen'>
        <div className='border border-gray-200 rounded-2xl bg-white overflow-hidden shadow-lg'>
          <div className='p-5 bg-linear-to-r from-blue-600 to-indigo-700 flex flex-col sm:flex-row justify-between items-center gap-2'>
            <div >
              <h1 className='text-white text-xl font-bold'>React state & From Yönetim paneli</h1>
            </div>
          ...
          <div className='col-span md:col-span-3 bg-white'>
